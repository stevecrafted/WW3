<?php
/**
 * Vue générique pour l'affichage de la liste des articles d'une section.
 *
...
<div class="section-header">
    <h1 class="section-header__title"><?= htmlspecialchars($section->title) ?></h1>
    ...
    <div class="une-grid">
        ...
        <article class="article article-hero" itemscope itemtype="https://schema.org/NewsArticle">
            ...
            <h2 class="article__title" itemprop="headline">
                <a href="/<?= htmlspecialchars($section->slug) ?>/<?= (int) $hero->id ?>-<?= htmlspecialchars($hero->slug) ?>">
            ...
            <div class="article__meta">
                <time class="article__meta-time"
                      datetime="<?= htmlspecialchars($hero->created_at) ?>"
        ...
        <?php else: ?>
            <p class="no-content">Aucun article disponible pour le moment.</p>
        <?php endif; ?>
...
<div class="content-with-sidebar">
    <section aria-labelledby="flux-title">
        <h2 class="subsection-title" id="flux-title">
            Tous les articles — <?= htmlspecialchars($section->name) ?>
        </h2>
        ...
        <div class="articles-list" role="feed" aria-busy="false">
            ...
            <article class="article article--inline" itemscope itemtype="https://schema.org/NewsArticle">
                ...
                <div class="article__body">
                    <span class="article__tag"><?= htmlspecialchars($section->name) ?></span>
                    <h3 class="article__title" itemprop="headline">
                        <a href="/<?= htmlspecialchars($section->slug) ?>/<?= (int) $article->id ?>-<?= htmlspecialchars($article->slug) ?>">
                    ...
                    <div class="article__meta">
                        <time class="article__meta-time" datetime="<?= htmlspecialchars($article->created_at) ?>">
